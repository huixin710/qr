        ...
        <section class="job-section job-featured-section section-padding" id="job-section">
            <div class="container">
                <div class="row">
                    <header class="w3-panel w3-center w3-opacity" style="padding:64px 16px text-center">
                        ...
                        <div class="w3-padding-32">
                            <div class="w3-bar w3-border text-center">
                                ...
                                <a href="history_end.php" class="w3-bar-item w3-button w3-light-grey w3-hide-small">已結束</a>
                            </div>
                        </div>
                    ...
                    //root系統管理員
                    if ($id == 'root') {
                        $result = mysqli_query($link, "SELECT `aid`,`aname`,`address`,`startdatetime`,`enddatetime`,`builddatetime` FROM `activites` WHERE `appid`='$id' AND `enddatetime`<'$today' ORDER BY `builddatetime`desc");
                    } else {
                        $result = mysqli_query($link, "SELECT `aid`,`aname`,`address`,`startdatetime`,`enddatetime`,`builddatetime` FROM `activites` WHERE `appid`='$id' AND `enddatetime`<'$today' ORDER BY `builddatetime`desc");
                    }
                    ...
                    if ($id == 'root') {
                        $result1 = mysqli_query($link, "SELECT `aid`,`aname`,`address`,`startdatetime`,`enddatetime`,`builddatetime` FROM `activites` WHERE `enddatetime`<'$today' ORDER BY `builddatetime`desc LIMIT $start,$per"); //每頁顯示項目數量
                    } else {
                        $result1 = mysqli_query($link, "SELECT `aid`,`aname`,`address`,`startdatetime`,`enddatetime`,`builddatetime` FROM `activites` WHERE `appid`='$id' AND `enddatetime`<'$today' ORDER BY `builddatetime`desc LIMIT $start,$per"); //每頁顯示項目數量
                    }
            ...
            <div class="col-lg-12 col-12 text-center mx-auto mb-4">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center mt-5">
                        ...
                        ?>
                        <li class="page-item">
                            <a class="page-link" href="history_end.php?page=1" aria-label="Previous">
                        ...
                        if ($data_nums != 0) {
                            if ($page != 1) { ?>
                                ...
                                <li class="page-item">
                                    <?php echo ' <a class="page-link" href="history_end.php?page=' . $page1 . ' ">'; ?>
                            ...
                            for ($i = 1; $i <= $pages; $i++) {
                                ...
                                ?>
                                        ...
                                        <?php //後面頁碼網址
                                        echo '<a class="page-link" href="history_end.php?page=' . $i . '">' . $i . '</a></li>';
                                    }
                                    if ($page != $i) { ?>
                                ...
                                <?php if ($page != $pages) { ?>
                                        ...
                                        <li class="page-item">
                                            <?php echo ' <a class="page-link" href="history_end.php?page=' . $page2 . ' ">'; ?>
                                    ...
                                    <li class="page-item">
                                        <?php echo ' <a class="page-link" href="history_end.php?page=1">'; ?>
                            ...
                            if ($data_nums == 0) {
                                ...
                                ?>
                                    <li class="page-item">
                                        <?php echo ' <a class="page-link" href="history_end.php?page=' . $pages . ' ">'; ?>
                                        <span aria-hidden="true">末頁</span>
                                        </a>
                                    </li>
                                <?php } ?>
