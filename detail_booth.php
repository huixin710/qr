        ...
        <div class="row">
          <form class="custom-form" action="" method="POST" role="form" enctype="multipart/form-data">
            <div class="title-group mb-3 text-center">
              <h1 style="color:#787878; font-weight:bold; font-size:50px;" class="mb-0">攤位資料</h1>
              <br>
              <hr><br>
            </div>
            <div id="carouselExampleDark" class="carousel carousel-dark slide col-lg-12 col-md-12 col-18 text-center" data-bs-ride="carousel">
              <div class="carousel-indicators">
                ...
                <?php
                $sql = "SELECT * FROM `booth` WHERE `bid` = $booth_id";
                $result = mysqli_query($link, $sql);
                $result2 = mysqli_query($link, "SELECT iname FROM `booth_img` WHERE `bid` = $booth_id");
            ...
            <div class="container">
              <div class="row">
                <?php
                echo "<h2 style='font-weight:bold; color:#787878;' class='new_tit'>攤位名稱</h2>";
                echo "<h3>" . $row['bname'] . "</h3><br><br>";
                echo "<h2 style='font-weight:bold; color:#787878;' class='new_tit'>攤位地點</h2>";
                echo "<h3>" . $row['address'] . "</h3><br><br>";
                echo "<h2 style='font-weight:bold; color:#787878;' class='new_tit'>活動負責人</h2>";
                echo "<h3>" . $row['b_head'] . "</h3><br><br>";
                echo "<h2 style='font-weight:bold; color:#787878;' class='new_tit'>介紹</h2>";
                echo "<h3>" . $row['introduce'] . "</h3><br><br>";
                  ...
                  ?>
                    <tr>
                      <div class="col-lg-6 col-6">
                        <?php echo "<a href='update_booth.php?bid=" . $row['bid'] . "&aid=" . $row['aid'] . "' style='background-color:#FFA600' class='custom-btn btn'><input type='button' name='bupdata' value='　　　修改　　　' style='background-color:transparent;  border:none; color:white;' ></a>"; ?>
                      </div>
                    </tr>

                    <tr>
                      <div class="col-lg-6 col-6">
                        <?php echo "<a href='booth.php?aid=" . $row['aid'] . "' style='background-color:#FFA600' class='custom-btn btn'><input type='button' value='　　　返回　　　' style='background-color:transparent;  border:none; color:white;' ></a>"; ?>
                      </div>
                    </tr>
                  <?php  } elseif (isset($_SESSION['uid'])) { ?>
                    <tr>
                      <div class="col-lg-6 col-6">
                        <?php echo "<a href='user_booth.php?uid=" . $uid . "&activity_id=" . $row['aid'] . "' style='background-color:#FFA600' class='custom-btn btn'><input type='button' value='　　　返回　　　' style='background-color:transparent;  border:none; color:white;' ></a>"; ?>
                      </div>
                    </tr>
                  <?php  } ?>
                </table>
  ...
  <script>
    $(function() {
      ...
      function createqrcode() {
        var input_text = "http://127.0.0.1/qrfun0828/qrcode_booth.php?bid=" + <?php echo $booth_id ?>; //qrcode網址
