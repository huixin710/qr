...
<head>
    ...
    <style>
        ...
        /* 選擇所有名稱為 "form-control" 的 <input> 元素 */


        /* 選擇具有 id 為 "demo_input" 的 <input> 元素 */
    </style>
    <!--
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-8 col-12 mx-auto" style="border:3px #696969 solid;">
                        <form class="custom-form contact-form" action="login_action_admin.php" method="post" role="form">
                            <h4 class="text-center mb-4" style="border-bottom-style: 2px  #696969 solid;">主辦方登入</h4>
                            ...
                            <div class="col-lg-4 col-md-4 col-6 mx-auto text-center">
                                <label class="msg_box2">
                                    ...
                                    <span style="vertical-align: top; color: #666 !important">顯示密碼 </span>
                                </label>
                            </div>
