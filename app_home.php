                        ...
                        <div class="job-thumb d-flex">
                            ...
                            <div class="job-body d-flex flex-wrap flex-auto align-items-center ms-4">
                                ...
                                <div class="job-section-btn-wrap">
                                    <?php echo "<a href='delete.php?aid=$row[0]' style='background-color:#FFA600' class='custom-btn btn'><input type='button' value='刪除' style='background-color: transparent;  border:none; color:white;' ></a>"; ?>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 col-12 text-center mx-auto mb-4">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center mt-5">
                        ...
                        ?>
                        <li class="page-item">
                            <a class="page-link" href="app_home.php?page=1" aria-label="Previous">
                        ...
                        if ($data_nums != 0) {
                            if ($page != 1) { ?>
                                ...
                                <li class="page-item">
                                    <?php echo ' <a class="page-link" href="app_home.php?page=' . $page1 . ' ">'; ?>
                            ...
                            for ($i = 1; $i <= $pages; $i++) {
                                ...
                                ?>
                                        ...
                                        <?php //後面頁碼網址
                                        echo '<a class="page-link" href="app_home.php?page=' . $i . '">' . $i . '</a></li>';
                                    }
                                    if ($page != $i) { ?>
                                ...
                                <?php if ($page != $pages) { ?>
                                        ...
                                        <li class="page-item">
                                            <?php echo ' <a class="page-link" href="app_home.php?page=' . $page2 . ' ">'; ?>
                                    ...
                                    <li class="page-item">
                                        <?php echo ' <a class="page-link" href="app_home.php?page=1">'; ?>
                            ...
                            if ($data_nums == 0) {
                                ...
                                ?>
                                    <li class="page-item">
                                        <?php echo ' <a class="page-link" href="app_home.php?page=' . $pages . ' ">'; ?>
                                        <span aria-hidden="true">末頁</span>
                                        </a>
                                    </li>
                                <?php } ?>
